    ...
    <div className="m-6 flex flex-col items-center h-screen">
      ...
      <div className="flex flex-col xl:max-w-7xl">
        ...
        <p>I am a thoughtful person that lives to make others happy and keep the vibes up. Willing to go the extra mile and then some. As a call center coordinator I am required to ensure quality and implement solutions to ever-changing issues whether it be customer or operation related.
          When I have free time {`you'll`} find me with my family. They are the best. Interested in chatting about a job opportunity on your team? Send me an email at kmantan@gmail.com or add me on <a href="https://linkedin.com/in/keenanaldridge">linkedin</a>
        </p>
      </div>
    </div>
  )
